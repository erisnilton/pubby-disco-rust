...
impl domain::activity::repository::ActivityRepository for SqlxActivityRepository {
  async fn create(
    &mut self,
    activity: &domain::activity::Activity,
  ) -> Result<domain::activity::Activity, domain::activity::repository::Error> {
    sqlx::query!(
  ...
  async fn find_by_id(
    &self,
    id: &shared::vo::UUID4,
  ) -> Result<Option<domain::activity::Activity>, domain::activity::repository::Error> {
